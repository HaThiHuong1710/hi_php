...
echo uppercaseString('Ha Thi Huong');
*/
...
echo lowercase_A_String('Ha Thi Huong');
*/
...
echo capitalize_First_Fetter('ha thi huong');
*/
...
echo remove_Whitespace("  ha thi huong   ");
*/
...
echo remove_The_First_Character('ha thi huong');
*/
...
echo remove_The_Last_Character('ha thi huong 1');
*/
...
print_r(split_String("ha thi huong")) ;#print_r dùng để in giá trị của mảng trong php
*/
...
echo join_Elements_Together(['hà', 'thi', 'huong']);
*/
...
echo add_String('hà thị hường', 'handsome');
*/
...
echo check_String('ha thi huong','huong');
*/
...
echo check_For_Existence('ha thi huong', 'nu' )
*/
...
echo replace_Character('','_','ha+thi+huong');
*/
...
echo check_Email('ngochuongg171002@gmail.com');
*/